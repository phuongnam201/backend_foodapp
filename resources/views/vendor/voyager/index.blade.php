...
//order data
$orderSuccess = \App\Order::where('payment_status', 'Paid')->count();
$orderCancelled = \App\Order::where('payment_status', 'Pending')->count();



//revenue
$totalRevenue = \App\Order::where('payment_status', 'Paid')->sum('order_amount');

// days
$totalRevenueToday = \App\Order::where('payment_status', 'Paid')
->whereDate('created_at', today())
->sum('order_amount');


// week
$totalRevenueThisWeek = \App\Order::where('payment_status', 'Paid')
->whereBetween('created_at', [now()->startOfWeek(), now()->endOfWeek()])
->sum('order_amount');


// month
$totalRevenueThisMonth = \App\Order::where('payment_status', 'Paid')
->whereMonth('created_at', now()->month)
->whereYear('created_at', now()->year)
->sum('order_amount');

// quuater
$totalRevenueThisQuarter = \App\Order::where('payment_status', 'Paid')
->whereBetween('created_at', [now()->startOfQuarter(), now()->endOfQuarter()])
->sum('order_amount');


// year
$totalRevenueThisYear = \App\Order::where('payment_status', 'Paid')
->whereYear('created_at', now()->year)
->sum('order_amount');
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{$totalRevenueToday}} VND</div>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{$totalRevenueThisWeek}} VND</div>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{$totalRevenueThisMonth}} VND</div>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{$totalRevenueThisYear}} VND</div>
                            </div>
                            <div class="col-auto">
                                <i class="fas fa-comments fa-2x text-gray-300"></i>
                            </div>
...
<script>
    ...
    dataOrder.push(orderSuccess,orderCancelled)
